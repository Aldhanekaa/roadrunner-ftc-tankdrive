...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_WHEEL_RADIUS = 3.54331 / 2; // in

    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double PARALLEL_GEAR_RATIO = 1/15; // or 15/20
    public static double PARALLEL_SPROCKET_RATIO = 1; // or 15/20
    ...
    public static double parallelTicksToInches(double ticks) {
        return PARALLEL_WHEEL_RADIUS * 2 * Math.PI * PARALLEL_GEAR_RATIO * PARALLEL_SPROCKET_RATIO * ticks / TICKS_PER_REV;
    }

    // the additional hd hex motor
    public static double perpendicularTicksToInches(double ticks) {
        return PERPENDICULAR_WHEEL_RADIUS * 2 * Math.PI  * ticks / TICKS_PER_REV;
    }
